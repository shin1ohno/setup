...
#   - orchestrator.sh     every 15 min  ssh-push mitamae-runner on each host
#
...
# cron — drift-checker every 2 min, orchestrator every 15 min.
...
cron_content = <<~CRON
  ...
  */15 * * * *  root  #{ORCHESTRATOR_BIN}  >> #{LOG_FILE} 2>&1
CRON
