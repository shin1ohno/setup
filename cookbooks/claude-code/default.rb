...
%w(pre-commit-test.rb check-trailing-newline.rb check-whitespace-lines.rb block-co-authored-by.rb post-compact-remind.rb mcp-health-check.rb detect-prose-menu.rb warn-loop-repo-shared-tree.rb warn-untracked-before-pull.rb).each do |file_name|
