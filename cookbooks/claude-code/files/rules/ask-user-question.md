...
8. **ユーザーが「その選択肢は間違えて選んだ」と申告した場合**は、その選択に基づく作業が進んでいても直ちに撤回し、以後その選択肢を候補から外す。申告は即座に来るので、進捗を理由に維持しない（項目 7 の「後から届いた信号が正」の、ユーザー自身による訂正版）。Origin: 2026-09-04 —「Notion は間違えて選択しました。Notion はないです」
