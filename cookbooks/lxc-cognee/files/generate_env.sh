...
# APM ApiKey for auth-proxy OTLP export.
APM_API_KEY=$(fetch_ssm "/monitoring/apm/api-keys/cognee-auth-proxy")
...
OTEL_EXPORTER_OTLP_HEADERS=authorization=ApiKey ${APM_API_KEY}
EOF
