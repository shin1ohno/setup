...
RTX_SNMP_COMMUNITY=$(fetch_ssm "/monitoring/rtx-snmp-community")
ELASTIC_VECTOR_PASSWORD=$(fetch_ssm "/monitoring/elastic/vector-password")

cat > "${OUTPUT_FILE}" <<EOF
# Auto-generated by lxc-monitoring cookbook — do not edit
GF_SECURITY_ADMIN_PASSWORD=${GRAFANA_ADMIN_PASSWORD}
PVE_TOKEN_VALUE=${PVE_TOKEN_VALUE}
RTX_SNMP_COMMUNITY=${RTX_SNMP_COMMUNITY}
ELASTIC_VECTOR_PASSWORD=${ELASTIC_VECTOR_PASSWORD}
EOF
