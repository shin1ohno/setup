...
#
# cookbooks/lxc-weave: the weave LXC (CT 109) service logic, extracted from
# pve/lxc-weave.rb (Phase 4 structural refactor). The thin entry recipe
# includes this cookbook then calls lxc_entry. weave is a 4-component MQTT mesh
# (mosquitto + roon-hub + weave-server + weave-web) connecting to lxc-roon at
