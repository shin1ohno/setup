...
#
# neovim, linux half: build from source. The distro package lags the version
# this config targets, so the toolchain is installed via apt and neovim is
# compiled. The darwin half takes the mise-managed prebuilt binary instead
# (cookbooks/neovim/darwin.rb).
#
