...
# The Roon CLIENT app, installed from the upstream .dmg into /Applications.
# darwin-only (cookbooks/roon/platform): the sole caller is cookbooks/mac-apps,
# which is itself darwin-marked, and the platform `case` this replaces had no
# second arm — every host that reaches this file is a Mac. Roon SERVER is a
# separate concern and lives in cookbooks/lxc-roon.
