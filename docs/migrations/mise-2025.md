# mise migration (2025-08-26)

> **Status: Deferred (2026-04-26)**
>
> Phase 1 (bat, fd, rg, tmux) は 2025-08-26 に完了。Phase 2/3 (neovim, fzf,
> terraform, lazygit, ansible, awscli, gcloud-cli) は未着手のまま 4 ヶ月静止。
> 再開時はこの注記を削除し、必要なら root 直下に戻す。
